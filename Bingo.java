    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= column.length; i++) {
            for (int j = 0; j < column.length; j++) {
                if (i < 1) { //because you can't multiply by 0 (unless you always want 0 as outcome), a separate random generation is made since we need to calculate the min-max with a multiplication of 15*i for the bingo card
